...
export type PaymentMethodArchivedSectionProps = {
...
export const PaymentMethodArchivedSection = memo(
  function PaymentMethodArchivedSection({
    archivedWallets,
    currencyCode,
    language,
    onUnarchive,
  }: PaymentMethodArchivedSectionProps) {
